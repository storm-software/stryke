...
<div align="center">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://public.storm-cdn.com/stryke/media/banner-1280x427-dark.gif">
  <source media="(prefers-color-scheme: light)" srcset="https://public.storm-cdn.com/stryke/media/banner-1280x427-light.gif">
<img src="https://public.storm-cdn.com/stryke/media/banner-1280x427-dark.gif" width="100%" alt="Stryke" />
</picture>
</div>
<br />
...
# Stryke - Date Utilities

A utility package that helps with date manipulation and formatting.
...
- [Stryke - Date Utilities](#stryke---date-utilities)
...
Run `nx lint date` to run [ESLint](https://eslint.org/) on the package.
