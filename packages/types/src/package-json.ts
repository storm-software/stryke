...
// eslint-disable-next-line ts/no-namespace -- mirrors type-fest PackageJson namespace layout
export namespace PackageJson {
  ...
  export interface PackageJsonStandard {
    ...
    /**
     * @deprecated This option is no longer used by npm.
     */
     ...
     *
     * @deprecated npm no longer enforces global installs for CLI packages.
     */
  ...
  export type PublishConfig = {
    ...
    Pick<
      PackageJsonStandard & NonStandardEntryPoints & TypeScriptConfiguration,
      | "bin"
      | "main"
      | "exports"
      | "types"
 ...
 */
// eslint-disable-next-line ts/no-redeclare -- merged with PackageJson namespace above
