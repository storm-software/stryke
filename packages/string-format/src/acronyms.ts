...
export const ACRONYMS = [
  ...
  "7G", // Seventh Generation (mobile networks)
  "8G", // Eighth Generation (mobile networks)
  ...
  "BFFs", // Best Friends Forever (plural)
  "BI", // Business Intelligence
  "BIOS", // Basic Input/Output System
  "BGP", // Border Gateway Protocol
  "BOM", // Bill of Materials / Byte Order Mark
  "BYOD", // Bring Your Own Device
  "C2C", // Consumer to Consumer
  "CAGR", // Compound Annual Growth Rate
  "CAPTCHA", // Completely Automated Public Turing test to tell Computers and Humans Apart
  "CD", // Continuous Delivery / Compact Disc
  ...
  "CSR", // Certificate Signing Request / Corporate Social Responsibility
  ...
  "EOF", // End Of File
  "EOD", // End Of Day / Explosive Ordnance Disposal
  "EPA", // Environmental Protection Agency
  "ER", // Emergency Room / Entity Relationship
  ...
  "P2P", // Peer to Peer
  "PDP", // Policy Decision Point / Product Detail Page
  "PDT", // Pacific Daylight Time
  "PGA", // Professional Golfers' Association
  "POTUS", // President of the United States
  "PST", // Pacific Standard Time
  "PTO", // Paid Time Off / Power Take-Off
  "PaaS", // Platform as a Service
  "PCI", // Payment Card Industry
  "PKI", // Public Key Infrastructure
  "PP", // Pages / PayPal / Percentage Points
  "PWA", // Progressive Web App
  "PX", // Pixel
  "QA", // Quality Assurance
  "R2", // Release 2 / Region 2
  ...
  "SMB", // Server Message Block / Small and Medium Business
  "SMTP", // Simple Mail Transfer Protocol
  "SOAP", // Simple Object Access Protocol
  "SOC", // Security Operations Center / System on Chip
  "SOA", // Service Oriented Architecture
  "SPDY", // Speedy (pronounced "SPeeDY")
