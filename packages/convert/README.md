...
# Stryke - Type Conversion Utilities
...
Run `nx build convert` to build the library.
...
Run `nx lint convert` to run [ESLint](https://eslint.org/) on the package.
